...
class ChapterFilters extends ConsumerStatefulWidget {
  ...
  const ChapterFilters({super.key, required this.manga});
        ...
        return Column(
          children: [
            ...
            ListTileItemFilter(
              ...
              type:
                  ref
                      .watch(chapterFilterUnreadStateProvider(mangaId: mangaId))
                      .type!,
              onTap: () {
                ref
                    .read(
                    ...
                    Expanded(
                      child: ElevatedButton(
                        onPressed: () {
                          showDialog(
                            context: context,
                            builder: _buildScanlatorsDialog,
                          );
                        },
        ...
        return AlertDialog(
          ...
          content: SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder:
                  (context, index) => ListTileItemFilter(
