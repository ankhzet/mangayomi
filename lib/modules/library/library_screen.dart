                      ...
                      if (data.isNotEmpty && showCategoryTabs) {
                        ...
                        return Consumer(builder: (context, ref, child) {
                          ...
                          final isNotFiltering = ref.watch(mangasFilterResultStateProvider(
                              itemType: widget.itemType, mangaList: _entries, settings: settings));
        ...
        .where((element) {
          ...
          if (downloadFilterType == 1) {
            for (var chap in element.chapters) {
              final modelChapDownload = isar.downloads.filter().idEqualTo(chap.id).findAllSync();
                  ...
                  content: SizedBox(
                      ...
                      child: Column(
                        children: [
                          ...
                          ListTileChapterFilter(
                            label:
                                widget.itemType != ItemType.anime ? l10n.downloaded_chapters : l10n.downloaded_episodes,
                            onTap: () {
                              setState(() {
                                    ...
                                    if (manga.isLocalArchive ?? false) {
                                      for (var chapter in manga.chapters) {
                                        try {
                                          ...
                                          try {
                                            try {
                                              if (File("${mangaDir!.path}${chapter.name}.cbz").existsSync()) {
                                                File("${mangaDir.path}${chapter.name}.cbz").deleteSync();
                                              }
                                            } catch (_) {}
                                            try {
                                              if (File("${mangaDir!.path}${chapter.name}.mp4").existsSync()) {
                                                File("${mangaDir.path}${chapter.name}.mp4").deleteSync();
                                              }
                                            } catch (_) {}
        ...
        return Column(
          children: [
            ...
            ListTileChapterFilter(
                ...
                type: ref.watch(
                    mangaFilterUnreadStateProvider(itemType: widget.itemType, mangaList: _entries, settings: settings)),
                onTap: () {
                  ref
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ListTileChapterFilter(
                        label: widget.itemType != ItemType.anime ? l10n.downloaded_chapters : l10n.downloaded_episodes,
