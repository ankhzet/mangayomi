...
extension UpdateQueryWhereSort on QueryBuilder<Update, Update, QWhere> {
  ...
  QueryBuilder<Update, Update, QAfterWhere> anyMangaId() {
    return QueryBuilder.apply(this, (query) {
...
extension UpdateQueryWhere on QueryBuilder<Update, Update, QWhereClause> {
  ...
  QueryBuilder<Update, Update, QAfterWhereClause> mangaIdIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<Update, Update, QAfterWhereClause> mangaIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<Update, Update, QAfterWhereClause> mangaIdEqualTo(int? mangaId) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<Update, Update, QAfterWhereClause> mangaIdNotEqualTo(
    int? mangaId,
  ) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
  ...
  QueryBuilder<Update, Update, QAfterWhereClause> mangaIdGreaterThan(
    int? mangaId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Update, Update, QAfterWhereClause> mangaIdLessThan(
    int? mangaId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Update, Update, QAfterWhereClause> mangaIdBetween(
    int? lowerMangaId,
    int? upperMangaId, {
    bool includeLower = true,
    bool includeUpper = true,
