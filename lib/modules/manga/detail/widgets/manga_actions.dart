                ...
                child: SizedBox(
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      String url =
                          manga.link!.startsWith('/')
                              ? "$baseUrl${manga.link!.getUrlWithoutDomain}"
                              : manga.link!;
