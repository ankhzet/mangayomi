...
class AsyncValueCombiner<Values extends Record, Async extends Record>
  ...
  static AsyncValueCombiner1<A> merge1<A>(AsyncValue<A> a) =>
      AsyncValueCombiner1([a]);

  static AsyncValueCombiner2<A, B> merge2<A, B>(
    AsyncValue<A> a,
    AsyncValue<B> b,
  ) => AsyncValueCombiner2([a, b]);

  static AsyncValueCombiner3<A, B, C> merge3<A, B, C>(
    AsyncValue<A> a,
    AsyncValue<B> b,
    AsyncValue<C> c,
  ...
  static AsyncValueCombiner<Values, Async> merge<
    Values extends Record,
    Async extends Record
  >(Async values) => AsyncValueCombiner(values.toList());
  ...
  Widget make(
    ...
    return _makeConsumer(this, [], data, error, loading);
  }
...
typedef AsyncRecord4<A, B, C, D> =
    (AsyncValue<A>, AsyncValue<B>, AsyncValue<C>, AsyncValue<D>);
...
class AsyncValueCombiner2<A, B>
    extends AsyncValueCombiner<(A, B), AsyncRecord2<A, B>> {
...
class AsyncValueCombiner3<A, B, C>
    extends AsyncValueCombiner<(A, B, C), AsyncRecord3<A, B, C>> {
...
class AsyncValueCombiner4<A, B, C, D>
    extends AsyncValueCombiner<(A, B, C, D), AsyncRecord4<A, B, C, D>> {
...
extension AsyncValueCombinerExt<A> on AsyncValue<A> {
  AsyncValueCombiner2<A, B> merge2<B>(AsyncValue<B> b) =>
      AsyncValueCombiner2([this, b]);

  AsyncValueCombiner3<A, B, C> merge3<B, C>(AsyncValue<B> b, AsyncValue<C> c) =>
