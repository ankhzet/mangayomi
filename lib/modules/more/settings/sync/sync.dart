...
class SyncScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final autoSyncFrequency = ref.watch(synchingProvider(syncId: 1)).autoSyncFrequency;
                ...
                children: [
                  SwitchListTile(
                      ...
                      onChanged: !isLogged
                          ? null
                          : (value) {
                              ref.read(SynchingProvider(syncId: 1).notifier).setSyncOn(value);
                            }),
                  ListTile(
                    onTap: () {
                      showDialog(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      return RadioListTile(
                                        ...
                                        onChanged: (value) {
                                          ref.read(synchingProvider(syncId: 1).notifier).setAutoSyncFrequency(value!);
                    ...
                    subtitle: Text(
                      autoSyncOptions.entries.where((o) => o.value == autoSyncFrequency).first.key,
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(l10n.sync_auto_warning,
                              softWrap: true, style: TextStyle(fontSize: 11, color: context.secondaryColor))
                        ],
                      ),
                    ),
                  ),
                        ...
                        children: [
                          IconButton(
                              onPressed: !isLogged
                                  ? null
                                  : () {
                                      ref.read(syncServerProvider(syncId: 1).notifier).startSync(l10n, false);
                                    },
                              icon: Icon(
                                Icons.sync,
                                                  ...
                                                  children: [
                                                    ...
                                                    ElevatedButton(
                                                        ...
                                                        onPressed: () {
                                                          ref
                                                              .read(syncServerProvider(syncId: 1).notifier)
                                                              .downloadFromServer(l10n, false, true);
                                                          Navigator.pop(context);
                                                        },
                                                        child: Text(
                                                          l10n.dialog_confirm,
                  ...
                  buildChangedItemWidget(l10n.sync_pending_manga,
                      changedParts.getChangedParts([ActionType.addItem, ActionType.removeItem, ActionType.updateItem])),
                  const SizedBox(height: 15),
                  buildChangedItemWidget(
                      l10n.sync_pending_chapter,
                      changedParts.getChangedParts(
                          [ActionType.addChapter, ActionType.removeChapter, ActionType.updateChapter])),
                  const SizedBox(height: 15),
                  buildChangedItemWidget(
                      l10n.sync_pending_category,
                      changedParts.getChangedParts(
                          [ActionType.addCategory, ActionType.removeCategory, ActionType.renameCategory])),
                  const SizedBox(height: 15),
                  buildChangedItemWidget(
                  ...
                  const SizedBox(height: 15),
                  buildChangedItemWidget(l10n.sync_pending_update,
                      changedParts.getChangedParts([ActionType.addUpdate, ActionType.clearUpdates])),
                  const SizedBox(height: 15),
                  buildChangedItemWidget(
                  ...
                  buildChangedItemWidget(
                      ...
                      changedParts
                          .getChangedParts([ActionType.addTrack, ActionType.removeTrack, ActionType.updateTrack])),
                  const SizedBox(height: 20),
                  Padding(
                    padding: const EdgeInsets.only(left: 15, right: 15, bottom: 10, top: 5),
                    child: Row(
                      children: [
                        ElevatedButton(
                            onPressed: !isLogged
                                ...
                                : () async {
                                    final snapshots =
                                        await ref.read(syncServerProvider(syncId: 1).notifier).getSnapshots(l10n);
                                    if (context.mounted) {
                                      showDialog(
                                          context: context,
                                          builder: (context) {
      ...
      children: [
        Text(
          ...
          style: TextStyle(
            ...
            background: Paint()
              ..color = changedParts.isEmpty ? Color.fromARGB(125, 78, 182, 92) : Color.fromARGB(123, 245, 233, 132)
              ..strokeWidth = 20
